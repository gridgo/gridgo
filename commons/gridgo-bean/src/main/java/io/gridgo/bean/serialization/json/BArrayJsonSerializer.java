...
public class BArrayJsonSerializer implements ReadWriteObject<BArray> {
    ...
    public void write(JsonWriter writer, BArray value) {
        ...
        if (size > 0) {
            ...
            compositeSerializer.write(writer, iterator.next());
    ...
    public BArray read(JsonReader reader) throws IOException {
        ...
        res.add(compositeSerializer.read(reader));
